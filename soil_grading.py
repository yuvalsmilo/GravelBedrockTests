...
class SoilGrading(Component):
    ...
    def create_transition_mat(self):
        ...
        # A matrix is this is the volume/weight that weathered from each size fraction
        # in each step
    ...
    def set_grading_classes(
        ...
        self._grid.at_node["grains_fractions__size"][self._grid.nodes] *= self._meansizes
